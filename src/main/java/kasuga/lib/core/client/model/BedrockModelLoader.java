...
@OnlyIn(Dist.CLIENT)
public class BedrockModelLoader implements IModelLoader<BedrockModel>, ResourceManagerReloadListener, ItemTransformProvider {
    ...
    @Override
    public BedrockModel read(@Nullable JsonDeserializationContext deserializationContext, JsonObject jsonObject) throws JsonParseException {
